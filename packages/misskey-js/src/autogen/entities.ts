...
export type StationsCreateRequest = operations['stations___create']['requestBody']['content']['application/json'];
export type StationsShowRequest = operations['stations___show']['requestBody']['content']['application/json'];
