...
import { MedilandHandlers } from "../../../mediland/mod.ts";
export const meta = {
	tags: ['users'],
...
@Injectable()
export class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
...
const Handlers: MedilandHandlers = {
	async Get(){
